...
// you can also manually replace with your go_package address as below:
// option go_package="github.com/<your_github_name>/<repo_name>/<path_in_repo>/{{ .Package }}/grpc-go";
{{ .Options }}
